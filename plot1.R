...
png("plot1.png") # plot device and file name

dat <- as.numeric(as.character(hh4$Global_active_power))
xl <- "Global Active Power (kilowatts)"

hist(dat, ylim=c(0, 1200), xlim=c(0,6), xlab=xl, main="Global Active Power", col=2)
